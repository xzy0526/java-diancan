...
public class WxOrderController {
    ...
    public ResultVO<Map<String, String>> create(@Valid OrderReq orderReq,
        ...
        //用户扣积分
        Float totalPrice = orderReq.getTotalPrice();
        UserInfo user = userRepository.findByOpenid(orderReq.getOpenid());
        user.setOpenid(orderReq.getOpenid());
        ...
        orderBean.setRemarks(orderReq.getRemarks());
